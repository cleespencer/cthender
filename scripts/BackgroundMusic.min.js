function BackgroundMusic() {
    this.tracks = "resources/music/2.mp3 resources/music/3.mp3 resources/music/4.mp3 resources/music/5.mp3 resources/music/6.mp3 resources/music/7.mp3 resources/music/9.mp3 resources/music/10.mp3 resources/music/11.mp3".split(" ");
    this.music = null
}
...
BackgroundMusic.prototype.next = function () {
    ...
    this.music = null;
    this.music = new Howl({urls: [this.tracks[Math.floor(Math.random() * this.tracks.length)]], onend: this.next.bind(this), volume: 1});
    this.music.play()
};
